...
const Communication = props =>
  <div className="auth">
    <div className="media-controls">
      <Link className="call-exit-button" to="/" className={'callbuttons'}>
      ...
      <button onClick={props.toggleAudio} className={'callbuttons audio-button-' + props.audio}>
      ...
      <button onClick={props.toggleVideo} className={'callbuttons video-button-' + props.video}>
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 50 50" className="svg">
      ...
      <button onClick={ToggleFullScreen} className="callbuttons fullscreen-button">
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 50 50" className="svg">
      ...
      <button onClick={props.handleHangup} className="callbuttons hangup-button">
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 50 50" className="svg">
